...
const EnglishKeys: typeof BaseLang = {
  ...
  "text.reboot.tip": "This configuration change requires a device reboot to take effect",
  "text.ok": "OK",
  "text.cancel": "Cancel",
  "text.detail": "Details",
  ...
  "tabs.base": "Basic",
  "tabs.about": "About",
  "text.reset.success": "Restored default settings",
  ...
  "advanced.enableDebugLog.detail": "Enabling this will write logs to '/data/local/SuToaster.log'. A device reboot is required for this to take effect.\nEnabling this will have a certain performance impact. Please enable it only when you need to send logs.",
  "advanced.test.showDebugToastButton": "Show Test Toast",
  "advanced.test.showDebugToastButton.description": "Click to show a test toast, used only for troubleshooting when an issue occurs. (Long press to show a longer-lasting toast)",
  "advanced.internalCooldown.label": "Toast Cooldown",
  "advanced.internalCooldown.description": "Enter a value between 0 and 10. Default: 3 seconds",
  "advanced.internalCooldown.description.detail": "When a specified app's superuser request is received, subsequent requests from that app will be ignored for the configured duration.\nA short duration may cause multiple pop-ups.",
